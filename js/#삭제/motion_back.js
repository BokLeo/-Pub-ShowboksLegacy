			...
			//------------------------------------------------- 플랫폼 관계(O) & 너비 관계(O) & 스크롤 관계(O) 실행 목록
							$(window).scroll(function(){
								...
								if(scNum > skillH + parseInt( $(".history_info").css("height"))  - 500 /*500*/  ){
									...
									var aaaa =  skillH + parseInt( $(".history_info").css("height"))  - 500;
									$("body").prepend("<div class='aa'>1</div>");
									$(".aa").css({position:"fixed",left:0, top:0, background:"rgba(0,0,0,0.7)", zIndex:100, height: aaaa  });
